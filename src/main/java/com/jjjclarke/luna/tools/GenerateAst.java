...
public class GenerateAst {
    ...
    private static void defineAst(
        ...
        writer.println("package com.jjjclarke.luna;");
        writer.println();
        writer.println("import java.util.List;");
        writer.println();
        writer.println("abstract class " + baseName + " {");

        defineVisior(writer, baseName, types);
    ...
    private static void defineVisior(PrintWriter writer, String baseName, List<String> types) {
